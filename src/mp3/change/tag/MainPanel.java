...
public class MainPanel extends JPanel {
	...
	private final JButton changeTagButton;
	...
	public MainPanel() {
		...
		/** change tag layout */
		JPanel changeTagPanel = new JPanel();
		changeTagPanel.setLayout(new GridLayout(5, 1));

		/** change tag chack box */
		for (int i = 0; i < 4; i++) {
		...
		/** change tag button */
		changeTagButton = new JButton("rename");
		changeTagButton.addActionListener(new ActionListener() {
			@Override
		...
		for (int i = 0; i < 4; i++) {
			changeTagPanel.add(checkBox[i]);
		}
		changeTagPanel.add(changeTagButton);
		...
		add(changeTagPanel, BorderLayout.NORTH);
